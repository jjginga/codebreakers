...
public class BooleanThreeAddressCode extends ThreeAddressCode {
    public BooleanThreeAddressCode(String operator, String operand1, String operand2, String result) {
